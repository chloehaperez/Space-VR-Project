...
/// Note that this works in any game with an orthographic camera!
/// </summary>
...
public class BoundsCheck : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        camWidth = camHeight * Camera.main.aspect; // Reliable way to calculate width
    }

    // Use LateUpdate to avoid races between this and the ship's movement
